...
def run_training(train_data: CrystalDataset, valid_data: CrystalDataset, test_data: CrystalDataset,
    ...
    # get the the training targets and unify the train target
    ...
    # Train ensemble of models, ensemble_size is 1
    for model_idx in range(args.ensemble_size):
        ...
        # Run training, minimize_score is true
