...
def add_predict_args(parser: ArgumentParser):
    ...
    parser.add_argument('--initdim', type=int, default=92,
                        help="one hot 92, element 438 ofm 1056 space 8")
    parser.add_argument('--seed', type=int, default=0,
                        help='Random seed to use when splitting data into train/val/test sets.'
                             'When `num_folds` > 1, the first fold uses this seed and all'
                             'subsequent folds add 1 to the seed.')
    parser.add_argument('--split_dir', type=str, default="seed_0",
                        help="Path of splitting file stored")
    parser.add_argument("--property", type=str, default="property.csv",
                        help="Specify the property file")
    parser.add_argument('--graph_dict', type=str,
                        help="File storing all the graph",
    ...
    parser.add_argument('--dataset_name', type=str,
                        choices=['band_gap', 'total_energy', 'per_atom_energy', 'formation_energy', 'efermi', 'magnetization', 'K', 'G'],
                        help='Choose a task')
...
def add_train_args(parser: ArgumentParser):
    ...
    parser.add_argument('--seed', type=int, default=0,
                        help='Random seed to use when splitting data into train/val/test sets.'
                             'When `num_folds` > 1, the first fold uses this seed and all'
                             'subsequent folds add 1 to the seed.')
    # I think we should not use seed here
    parser.add_argument('--split_dir', type=str, default="seed_0",
                        help="Path of splitting file stored")
    parser.add_argument("--property", type=str, default="property.csv",
                        help="Specify the property file")
    ...
    parser.add_argument('--space_feature', action='store_true', default=False,
                        help='Using space feature in training')
    ...
    parser.add_argument('--activation', type=str, default='ReLU',
                        choices=['ReLU', 'LeakyReLU', 'PReLU', 'tanh', 'SELU', 'ELU', 'Mish', 'GELU'],
    ...
    parser.add_argument('--max_num_neighbors', type=int, default=8,
